...
export default async function ApprovedQueuePage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <QueuePage title={result.queue.labelAr} description={result.queue.descriptionAr} items={result.items} pagination={result.pagination} basePath="/cases/queues/approved" searchParams={params} emptyTitle="لا توجد حالات معتمدة نشطة حالياً" />;
}
