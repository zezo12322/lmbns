...
export default async function UnderReviewQueuePage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <QueuePage title={result.queue.labelAr} description={result.queue.descriptionAr} items={result.items} pagination={result.pagination} basePath="/cases/queues/under-review" searchParams={params} emptyTitle="لا توجد حالات تحت المراجعة حالياً" />;
}
