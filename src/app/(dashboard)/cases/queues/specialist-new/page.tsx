...
export default async function SpecialistNewCasesQueuePage({
  searchParams,
}: {
  ...
  return (
    <QueuePage
      title={result.queue.labelAr}
      description={result.queue.descriptionAr}
      items={result.items}
      pagination={result.pagination}
      basePath="/cases/queues/specialist-new"
      searchParams={params}
      emptyTitle="لا توجد حالات جديدة مسندة لك الآن"
    />
  );
}
