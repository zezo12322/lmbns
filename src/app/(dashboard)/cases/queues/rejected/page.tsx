...
export default async function RejectedQueuePage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <QueuePage title={result.queue.labelAr} description={result.queue.descriptionAr} items={result.items} pagination={result.pagination} basePath="/cases/queues/rejected" searchParams={params} emptyTitle="لا توجد حالات مرفوضة مبدئيًا حالياً" />;
}
